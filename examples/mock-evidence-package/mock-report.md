...
- Evidence:
  ...
  - evd-mock-git-001: git, mock-git-log/git-log.json:1, locator `mock-a1b2c3d`
  - evd-mock-chat-002: wechat, mock-wechat-export/messages.jsonl:2, locator `mock 环境联调`
...
- Evidence:
  ...
  - evd-mock-chat-004: group_chat, mock-wechat-export/messages.jsonl:4, locator `示例告警数量`
...
- Evidence:
  ...
  - evd-mock-git-002: git, mock-git-log/git-log.json:3, locator `mock-d4e5f6g`
  - evd-mock-chat-006: group_chat, mock-wechat-export/messages.jsonl:6, locator `示例指标保持稳定`
...
- Evidence:
  - evd-mock-chat-007: wechat, mock-wechat-export/messages.jsonl:7, locator `mock 数据修复任务`
  - evd-mock-git-003: git, mock-git-log/git-log.json:4, locator `mock-r7s8t9u`
  - evd-mock-chat-008: wechat, mock-wechat-export/messages.jsonl:8, locator `示例导入结果`
